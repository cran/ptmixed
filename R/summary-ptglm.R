#' Summarizing Poisson-Tweedie GLM estimation results
#' 
#' Provides parameter estimates, standard errors and univariate Wald test
#' for the Poisson-Tweedie generalized linear model
#' 
#' @param object an object of class \code{ptglm} (obtained from \code{ptglm}).
#' @param ... Further arguments passed to or from other methods.
#' @return A list with the following elements: \code{logl}, \code{coefficients}, 
#' \code{D}, \code{a}
#' @export
#' @author Mirko Signorelli
#' @seealso \code{\link{ptglm}} and the examples therein
